...
#####################################
# Define Buzzwords to Issue Alert
# #####################################

KEYWORDS = {
    "Injury", "Red card", "Penalty", "VAR decision", "Offside", "Own goal", 
    "Suspended", "Sacked", "Hat-trick", "Upset", "Transfer", "Breaking news", 
    "Champions", "Relegation", "Goal drought", "Unbeaten streak", "Title race", 
    "Top four", "Golden Boot", "Managerial change"
}
...
def process_message(message: str) -> None:
    ...
    try:
        ...
        for alert in KEYWORDS:
            if alert.lower() in message_text.lower():
                logger.critical(f" ALERT: '{message_text}' from {author} contains '{alert}'!")
